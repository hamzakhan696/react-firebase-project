    ...
    {product ? (
      <div key={product.id} className="max-w-xs rounded-xl px-8 py-5 text-gray-600 shadow-2xl mt-12">
        ...
        <div className="mb-6 text-gray-400">
          <p> <span className='text-gray-900 '>Price:</span> ${product.price}</p>
          <p> <span className='text-gray-900'>Description:</span>  {product.description}</p>
          <p> <span className='text-gray-900 '>Manufacturer:</span> {product.manufacturer}</p>
          <p><span className='text-gray-900'>Stock quantity:</span> {product.stock_quantity}</p>
          <p><span className='text-gray-900'>Type:</span>  {product.type}</p>
        </div>
